...
export const dataService = {
  ...
  async createActivity(activity: {
    ...
    const { data, error } = await supabase
      ...
      .insert({
        ...
        session_type: activity.session_type || 'activity',
      } as any)
      .select()
      .single();
    if (error) {
  ...
  DEMO_EVENT_ID: '00000000-0000-0000-0000-000000000004' as string,
  DEMO_EVENT_SESSION_ID: '00000000-0000-0000-0000-000000000005' as string,
  DEMO_BALLOT_ID: '5533481a-fbf9-470b-a4d2-3b12c43ba7da' as string,
  ...
  isDemoItem(id: string): boolean {
    const demoIds = [
      ...
      '5533481a-fbf9-470b-a4d2-3b12c43ba7da',
    ];
